              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {vehicles.map((v) => {
                  ...
                  return (
                    <div
                      key={v.id}
                      className="bg-slate-900 border border-slate-800 rounded-2xl p-5 hover:border-cyan-500/40 transition-colors group flex flex-col justify-between"
                    >
                      <div>
                        {/* Header Plat */}
            ...
            {isLoadingData ? (
              ...
              <div className="space-y-3">
                {inspections.map((ins) => (
                  <div
                    key={ins.id}
                    className="bg-slate-900 border border-slate-800 hover:border-slate-700 rounded-2xl p-5 transition-colors flex flex-col md:flex-row md:items-center justify-between gap-4"
                  >
                    ...
                    <div className="flex items-center justify-between md:justify-end gap-4 border-t md:border-t-0 pt-3 md:pt-0 border-slate-800">
                      ...
                      <button
                        onClick={() => router.push(`/user/inspections/${ins.id}`)}
                        className="px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 text-white text-xs font-semibold rounded-xl shadow-md shadow-cyan-500/10 transition-all flex items-center gap-1.5"
                      >
        ...
        {activeTab === 'profile' && (
          <section className="w-full space-y-6">
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-6 pb-6 border-b border-slate-800/80">
                <div>
                  <h3 className="text-xl font-bold text-white mb-1">My Profile Settings</h3>
                  <p className="text-xs text-slate-400">Update your personal contact information and account password</p>
                </div>
              </div>
              ...
              {profileSuccess && (
                <div className="mb-6 p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-xl text-emerald-300 text-xs flex items-center gap-2">
              ...
              <form onSubmit={handleProfileSave} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      disabled
                      value={user.email}
                      className="w-full px-4 py-3 bg-slate-950/40 border border-slate-800/80 rounded-xl text-slate-400 text-sm cursor-not-allowed"
                    />
                  </div>
                ...
                <div className="flex justify-end pt-4">
                  <button
                    ...
                    className="w-full sm:w-auto px-8 py-3.5 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 text-white font-semibold text-sm rounded-xl shadow-lg shadow-cyan-500/20 transition-all disabled:opacity-50"
                  >
